export function AppDownloads() {
  return <div className="platform-grid">
    <article className="platform-card">
      <div className="platform-top"><span className="platform-symbol" aria-hidden="true">⊞</span><span className="release-tag">Desktop studio</span></div>
    ...
    <article className="platform-card mobile-platform">
      <div className="platform-top"><span className="platform-symbol" aria-hidden="true">▯</span><span className="release-tag">Pocket studio</span></div>
