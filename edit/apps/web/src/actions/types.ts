...
const ALL_ACTIONS: ReadonlySet<string> = new Set([
	"toggle-play", "stop-playback", "seek-forward", "seek-backward",
	"frame-step-forward", "frame-step-backward", "jump-forward", "jump-backward",
	...
	"toggle-bookmark", "undo", "redo", "remove-media-asset", "remove-media-assets",
]);

export function isActionWithOptionalArgs(value: string): value is TActionWithOptionalArgs {
	return ALL_ACTIONS.has(value);
}
