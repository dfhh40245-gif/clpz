...
import { ClpzCaptionsListener } from "@/components/editor/clpz-captions-listener";
...
function DegradedRendererBanner() {
	...
	return (
		<div className="bg-accent border-b h-9 flex items-center justify-center gap-2 text-xs text-muted-foreground">				<span>For the best experience, use Chrome.</span>
			<Button
				variant="text"
				size="icon"
